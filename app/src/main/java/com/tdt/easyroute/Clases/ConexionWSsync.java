...
public class ConexionWSsync extends AsyncTask<String,Integer,Boolean> {
    ...
    public ConexionWSsync(Context context, String metodo) {
    ...
    @Override protected void onPreExecute() {
        ...
        Log.d("salida","asyncTask: Iniciada");
    }
    ...
    protected Boolean doInBackground(String... strings) {
        ...
        Log.d("salida","asyncTask: doinbackground");
    ...
    protected void onPostExecute(Boolean result) {
        ...
        Log.d("salida","asyncTask: Terminada");
