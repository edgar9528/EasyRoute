...
public class SugeridoFragment extends Fragment {
            ...
            public void onClick(View view) {
                try
                {
                    if (sugeridoIndice >= 0)
                    {
                        ...
                        if(dgSugerido.size()>=sugeridoIndice)
                        {
    ...
    private void buscarSKU(String sku,String cant)
    {
        ...
        if(r!=null)
        {
            ...
            Log.d("salida","Entro aqui, r con datos");
        }
        else
        {
            DataTableLC.Productos_Sug ri=null;

            Log.d("salida","Entro aqui, r nulo");

            Log.d("salida", "SKU BUSCAR 2: "+sku);
            ...
            if(ri!=null)
            {
                Log.d("salida","Entro aqui, ri con datos");
