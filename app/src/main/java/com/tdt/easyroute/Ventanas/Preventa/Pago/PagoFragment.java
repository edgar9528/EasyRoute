...
public class PagoFragment extends Fragment {
    ...
    private PagosPrevAdapterRecyclerView pagosAdapterRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            pagosAdapterRecyclerView = new PagosPrevAdapterRecyclerView(dgPagos, R.layout.cardview_pagos, this);
        ...
        try
        {
            ...
            sp_forma.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if(reqBan[0])
                        ti_banco.setEnabled(false); //cambiar a true para activar banco
                    else
                    {
                    ...
                    if(reqRef[0])
                        ti_referencia.setEnabled(false); //cambiar a true para activar referencia
                    else
                    {
