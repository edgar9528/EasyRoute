...
public class VentaPrevAdapterRecyclerView extends RecyclerView.Adapter<VentaPrevAdapterRecyclerView.VentaViewHolder> {

    private ArrayList<DataTableLC.ProductosPed> ventaCardViews;
    private int resource;
    private VentavenFragment ventavenFragment;

    public VentaPrevAdapterRecyclerView(ArrayList<DataTableLC.ProductosPed> ventaCardViews, int resource, VentavenFragment ventavenFragment) {
    ...
    @NonNull
    @Override
    public VentaPrevAdapterRecyclerView.VentaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull VentaPrevAdapterRecyclerView.VentaViewHolder ventaViewHolder, final int position) {
