...
public class AbonosPrevAdapterRecyclerView extends RecyclerView.Adapter<AbonosPrevAdapterRecyclerView.PagosViewHolder> {

    private ArrayList<DataTableLC.DgPagos> pagoCardViews;
    private int resource;
    private AbonosFragment pagoFragment;

    public AbonosPrevAdapterRecyclerView(ArrayList<DataTableLC.DgPagos> pagoCardViews, int resource, AbonosFragment pagoFragment) {
    ...
    @NonNull
    @Override
    public AbonosPrevAdapterRecyclerView.PagosViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AbonosPrevAdapterRecyclerView.PagosViewHolder ventaViewHolder, int position) {
    ...
    private void click(AbonosPrevAdapterRecyclerView.PagosViewHolder ventaViewHolder, View v)
    {
