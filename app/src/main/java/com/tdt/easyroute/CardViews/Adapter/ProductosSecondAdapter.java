...
public class ProductosSecondAdapter extends BaseExpandableListAdapter {
    ...
    public ProductosSecondAdapter(Context context, String[] headers, List<String[]> data, FamiliavenFragment familiavenFragment) {
