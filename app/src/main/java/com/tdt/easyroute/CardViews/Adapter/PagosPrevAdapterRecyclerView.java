...
public class PagosPrevAdapterRecyclerView extends RecyclerView.Adapter<PagosPrevAdapterRecyclerView.PagosViewHolder> {

    private ArrayList<DataTableLC.DgPagos> pagoCardViews;
    private int resource;
    private PagoFragment pagoFragment;

    public PagosPrevAdapterRecyclerView(ArrayList<DataTableLC.DgPagos> pagoCardViews, int resource, PagoFragment pagoFragment) {
    ...
    @NonNull
    @Override
    public PagosPrevAdapterRecyclerView.PagosViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final PagosPrevAdapterRecyclerView.PagosViewHolder ventaViewHolder, int position) {
    ...
    private void click(PagosPrevAdapterRecyclerView.PagosViewHolder ventaViewHolder, View v)
    {
